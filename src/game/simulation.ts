import { tickCompetition, marketEffects } from './competition';
import {
  REPUTATION_PER_DAY,
  averageSatisfaction,
  pressurePenalty,
...
import { tickBoard, developDistrict } from './board';
import {
  CONTRACT_CONTENTION,
  ENERGY,
  DIFFICULTY,
...
import { CITY_EVENTS, cityEventCopy, companyName, enterpriseName, handleName, makePost, makeSwitchPost } from './names';
import { computeRoutes, loadServices, servingNodes, type TrafficService } from './network';
import { siteDrawKw, tickEnergyMonth } from './energy';
...
export const emptyServiceTraffic = (): ServiceTraffic => ({
  residential: 0,
  business: 0,
  mobile: 0,
  wholesale: 0,
