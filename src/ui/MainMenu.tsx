        ...
        <div className="hidden lg:block">
          ...
          <div className="mt-10 h-44 w-full max-w-sm rounded-sm border border-white/[0.08] bg-black/10 p-5">
            <svg viewBox="0 0 360 130" className="h-full w-full text-neon-cyan" aria-hidden="true">
              <path
                d="M35 86 105 46l72 32 65-52 82 58"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                strokeDasharray="7 7"
              ...
              {[
                ...
                <g key={i}>
                  <circle cx={x} cy={y} r="9" fill="#09111f" stroke="currentColor" strokeWidth="2" />
                  <circle cx={x} cy={y} r="2.5" fill="currentColor" />
                </g>
              ))}
              <path d="M35 105h289" stroke="rgba(255,255,255,.08)" />
              <text x="35" y="124" fill="rgba(220,231,243,.35)" fontSize="9" fontFamily="IBM Plex Mono">
                BACKBONE STATUS / READY FOR COMMISSIONING
              </text>
            </svg>
          </div>
        </div>
        ...
        {!setup ? (
          <div className="panel min-w-0 overflow-hidden border-white/[0.12] p-4 sm:p-6">
            <div className="mb-4 lg:hidden">
              ...
              <h1 className="mt-1 font-display text-4xl font-semibold uppercase">
